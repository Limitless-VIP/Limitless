Contributing to Limitless Core
============================
...
The following applies to code changes to the Limitless Core project, and is not to be
confused with overall Limitless Network Protocol consensus changes.
