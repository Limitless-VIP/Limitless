TittieCoin Core version 2.2.1 is now available from:

  <https://github.com/tittiecoin-project/tittiecoin/releases>
...
Please report bugs using the issue tracker at github:
  ...
  <https://github.com/tittiecoin-project/tittiecoin/issues>

Compatibility
==============

TittieCoin Core is extensively tested on multiple operating systems using
...
TittieCoin Core should also work on most other Unix-like systems but is not
...
of Bitcoin that TittieCoin was forked from.
...
As well as everyone that helped translating on [Transifex](https://www.transifex.com/projects/p/tittiecoin-project-translations/).
