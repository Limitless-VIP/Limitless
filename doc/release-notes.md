Limitless Core version 2.2.1 is now available from:

  <https://github.com/limitless-project/limitless/releases>
...
Please report bugs using the issue tracker at github:
  ...
  <https://github.com/limitless-project/limitless/issues>

Compatibility
==============

Limitless Core is extensively tested on multiple operating systems using
...
Limitless Core should also work on most other Unix-like systems but is not
...
of Bitcoin that Limitless was forked from.
...
As well as everyone that helped translating on [Transifex](https://www.transifex.com/projects/p/limitless-project-translations/).
