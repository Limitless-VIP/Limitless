...
Note
---------------------
Always use absolute paths to configure and compile limitless and the dependencies,
...
If you want to build Limitless-Qt, make sure that the required packages for Qt development
...
Once these are installed, they will be found by configure and a limitless-qt executable will be
built by default.
...
Security
--------
To help make your Limitless installation more secure by making certain attacks impossible to
...
* Non-executable Stack
    ...
    vulnerable buffers are found. By default, limitless should be built with a non-executable stack
