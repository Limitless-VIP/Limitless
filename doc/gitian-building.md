...
*Setup instructions for a gitian build of Limitless using a Debian VM or physical system.*
...
Clone the git repositories for limitless and gitian and then checkout the limitless version that you want to build.

```bash
git clone https://github.com/devrandom/gitian-builder.git
git clone https://github.com/limitless-crypto/limitless.git
cd limitless
...
Follow the instructions in [doc/release-process.md](release-process.md) in the limitless repository
...
To build Limitless (for Linux, OSX and Windows) just follow the steps under 'perform
gitian builds' in [doc/release-process.md](release-process.md) in the limitless repository.
...
```bash
    ...
    From https://github.com/limitless-crypto/limitless
...
For example:
```bash
URL=https://github.com/crowning-/limitless.git
...
[limitless/gitian.sigs](https://github.com/limitless-crypto/gitian.sigs/) repository, or if that's not possible to create a pull
request.
