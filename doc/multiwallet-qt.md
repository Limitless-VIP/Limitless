...
In order to support loading of multiple wallets in tittiecoin-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is tittiecoin.cpp.
...
Changes to tittiecoin.cpp
----------------------
tittiecoin.cpp is the entry point into tittiecoin-qt, and as such, will require some minor modifications to provide hooks for
