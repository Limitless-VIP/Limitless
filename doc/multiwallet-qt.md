...
In order to support loading of multiple wallets in limitless-qt, a few changes in the UI architecture will be needed.
...
----------------------
limitless.cpp is the entry point into limitless-qt, and as such, will require some minor modifications to provide hooks for
