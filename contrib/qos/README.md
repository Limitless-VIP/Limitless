...
This means one can have an always-on limitlessd instance running, and another local limitlessd/limitless-qt instance which connects to this node and receives blocks from it.
