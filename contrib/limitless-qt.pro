...
SOURCES += src/activemasternode.cpp \
           ...
           src/obfuscation.cpp \
           src/limitless-cli.cpp \
           src/limitless-tx.cpp \
           src/limitless.cpp \
           src/db.cpp \
           ...
           src/qt/limitless.cpp \
           src/qt/limitlessstrings.cpp \
...
RESOURCES += src/qt/limitless.qrc src/qt/limitless_locale.qrc

TRANSLATIONS += src/qt/locale/limitless_bg.ts \
                src/qt/locale/limitless_de.ts \
                src/qt/locale/limitless_en.ts \
                src/qt/locale/limitless_es.ts \
                src/qt/locale/limitless_fi.ts \
                src/qt/locale/limitless_fr.ts \
                src/qt/locale/limitless_it.ts \
                src/qt/locale/limitless_ja.ts \
                src/qt/locale/limitless_pl.ts \
                src/qt/locale/limitless_pt.ts \
                src/qt/locale/limitless_ru.ts \
                src/qt/locale/limitless_sk.ts \
                src/qt/locale/limitless_sv.ts \
                src/qt/locale/limitless_vi.ts \
                src/qt/locale/limitless_zh_CN.ts \
                src/qt/locale/limitless_zh_TW.ts
