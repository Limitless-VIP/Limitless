...
from fake_stake.base_test import FakeStakeTest

class zcValidCoinSpendTest(FakeStakeTest):
    ...
    def run_test(self):
        ...
        # 2) Mint zerocoins
        self.log.info("Minting %d-denom zVIPs..." % DENOM_TO_USE)
