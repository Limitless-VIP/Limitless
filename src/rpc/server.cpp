...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* VIP features */
        {"limitless", "listmasternodes", &listmasternodes, true, true, false},
        {"limitless", "getmasternodecount", &getmasternodecount, true, true, false},
        {"limitless", "masternodeconnect", &masternodeconnect, true, true, false},
        {"limitless", "createmasternodebroadcast", &createmasternodebroadcast, true, true, false},
        {"limitless", "decodemasternodebroadcast", &decodemasternodebroadcast, true, true, false},
        {"limitless", "relaymasternodebroadcast", &relaymasternodebroadcast, true, true, false},
        {"limitless", "masternodecurrent", &masternodecurrent, true, true, false},
        {"limitless", "masternodedebug", &masternodedebug, true, true, false},
        {"limitless", "startmasternode", &startmasternode, true, true, false},
        {"limitless", "createmasternodekey", &createmasternodekey, true, true, false},
        {"limitless", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"limitless", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"limitless", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"limitless", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"limitless", "getmasternodescores", &getmasternodescores, true, true, false},
        {"limitless", "preparebudget", &preparebudget, true, true, false},
        {"limitless", "submitbudget", &submitbudget, true, true, false},
        {"limitless", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"limitless", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"limitless", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"limitless", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"limitless", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"limitless", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"limitless", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"limitless", "checkbudgets", &checkbudgets, true, true, false},
        {"limitless", "mnsync", &mnsync, true, true, false},
        {"limitless", "spork", &spork, true, true, false},
        {"limitless", "getpoolinfo", &getpoolinfo, true, true, false},
        ...
        {"hidden", "createrawzerocoinstake", &createrawzerocoinstake, false, false, true},
        {"hidden", "createrawzerocoinpublicspend", &createrawzerocoinpublicspend, false, false, true},
        ...
        {"hidden", "spendrawzerocoin", &spendrawzerocoin, true, false, false},
        {"hidden", "spendzerocoinmints", &spendzerocoinmints, false, false, true},
        ...
        {"hidden", "getspentzerocoinamount", &getspentzerocoinamount, false, false, false},
        {"hidden", "getzvipseed", &getzvipseed, false, false, true},
        {"hidden", "setzvipseed", &setzvipseed, false, false, true},
        {"hidden", "generatemintlist", &generatemintlist, false, false, true},
        {"hidden", "searchdzvip", &searchdzvip, false, false, true},
        {"hidden", "dzvipstate", &dzvipstate, false, false, true},
        {"hidden", "clearspendcache", &clearspendcache, false, false, true}
...
{
    return "> limitless-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(std::string methodname, std::string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:8008/\n";
}
