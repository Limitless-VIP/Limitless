...
UniValue preparebudget(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 6)
        throw std::runtime_error(
            "preparebudget \"proposal-name\" \"url\" payment-count block-start \"limitless-address\" monthy-payment\n"
            ...
            "5. \"limitless-address\":   (string, required) VIP address to send payments to\n"
            ...
            "\nExamples:\n" +
            HelpExampleCli("preparebudget", "\"test-proposal\" \"http://limitlessvip.co.za/t/test-proposal\" 2 820800 \"TPfCkKQPK1FURXoAbvgEZUGK7pabqjwqPS\" 500") +
            HelpExampleRpc("preparebudget", "\"test-proposal\" \"http://limitlessvip.co.za/t/test-proposal\" 2 820800 \"TPfCkKQPK1FURXoAbvgEZUGK7pabqjwqPS\" 500"));
...
UniValue submitbudget(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 7)
        throw std::runtime_error(
            "submitbudget \"proposal-name\" \"url\" payment-count block-start \"limitless-address\" monthly-payment \"fee-tx\"\n"
            ...
            "\nExamples:\n" +
            HelpExampleCli("submitbudget", "\"test-proposal\" \"http://limitlessvip.co.za/t/test-proposal\" 2 820800 \"TPfCkKQPK1FURXoAbvgEZUGK7pabqjwqPS\" 500") +
            HelpExampleRpc("submitbudget", "\"test-proposal\" \"http://limitlessvip.co.za/t/test-proposal\" 2 820800 \"TPfCkKQPK1FURXoAbvgEZUGK7pabqjwqPS\" 500"));
