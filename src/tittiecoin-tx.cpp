...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("TittieCoin Core tittiecoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  tittiecoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded tittiecoin transaction") + "\n" +
                               "  tittiecoin-tx [options] -create [commands]   " + _("Create hex-encoded tittiecoin transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded tittiecoin transaction
