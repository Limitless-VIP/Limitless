...
#ifndef LIMITLESS_ZCWALLET_H
#define LIMITLESS_ZCWALLET_H
...
public:
    CzcWallet(std::string strWalletFile);
    ...
    void GenerateDeterministicZC(libzerocoin::CoinDenomination denom, libzerocoin::PrivateCoin& coin, CDeterministicMint& dMint, bool fGenerateOnly = false);
    ...
    void UpdateCount();
    void Lock();
    void SeedToZC(const uint512& seed, CBigNum& bnValue, CBigNum& bnSerial, CBigNum& bnRandomness, CKey& key);
