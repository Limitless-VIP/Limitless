...
#ifndef LIMITLESS_ZCTRACKER_H
#define LIMITLESS_ZCTRACKER_H
...
public:
    CzcTracker(std::string strWalletFile);
    ~CzcTracker();
    void Add(const CDeterministicMint& dMint, bool isNew = false, bool isArchived = false, CzcWallet* zVIPWallet = NULL);
