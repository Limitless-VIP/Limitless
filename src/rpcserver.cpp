...
Value stop(const Array& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop Limitless server.");
    // Shutdown will take long enough that the response should get back
    StartShutdown();
    return "Limitless server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Limitless features */
        {"limitless", "masternode", &masternode, true, true, false},
        {"limitless", "masternodelist", &masternodelist, true, true, false},
        {"limitless", "mnbudget", &mnbudget, true, true, false},
        {"limitless", "mnbudgetvoteraw", &mnbudgetvoteraw, true, true, false},
...
#ifdef ENABLE_WALLET
        {"limitless", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use limitlessd, or the -server option to limitless-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
