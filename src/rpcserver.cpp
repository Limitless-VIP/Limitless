...
Value stop(const Array& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop TittieCoin server.");
    // Shutdown will take long enough that the response should get back
    StartShutdown();
    return "TittieCoin server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* TittieCoin features */
        {"tittiecoin", "masternode", &masternode, true, true, false},
        {"tittiecoin", "masternodelist", &masternodelist, true, true, false},
        {"tittiecoin", "mnbudget", &mnbudget, true, true, false},
        {"tittiecoin", "mnbudgetvoteraw", &mnbudgetvoteraw, true, true, false},
        {"tittiecoin", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"tittiecoin", "mnsync", &mnsync, true, true, false},
        {"tittiecoin", "spork", &spork, true, true, false},
#ifdef ENABLE_WALLET
        {"tittiecoin", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use tittiecoind, or the -server option to tittiecoin-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> tittiecoin-cli " + methodname + " " + args + "\n";
}
