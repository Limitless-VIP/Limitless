...
UniValue bip38encrypt(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 2)
        throw std::runtime_error(
            "bip38encrypt \"limitlessaddress\" \"passphrase\"\n"
            ...
            "\nExamples:\n" +
            HelpExampleCli("bip38encrypt", "\"TPZDAaACPtKkBAEf2EsKJLMPiDML2APWoM\" \"mypasphrase\"") +
            HelpExampleRpc("bip38encrypt", "\"TPZDAaACPtKkBAEf2EsKJLMPiDML2APWoM\" \"mypasphrase\""));
...
UniValue bip38decrypt(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 2)
        throw std::runtime_error(
            "bip38decrypt \"limitlessaddress\" \"passphrase\"\n"
