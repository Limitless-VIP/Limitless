...
#include "spork.h"
#include "zc/deterministicmint.h"
...
UniValue getnewaddress(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() > 1)
        throw std::runtime_error(
            ...
            "\nResult:\n"
            "\"limitlessaddress\"    (string) The new limitless address\n"
...
UniValue getaccountaddress(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 1)
        throw std::runtime_error(
            ...
            "\nResult:\n"
            "\"limitlessaddress\"   (string) The account limitless address\n"
...
UniValue setaccount(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() < 1 || params.size() > 2)
        throw std::runtime_error(
            "setaccount \"limitlessaddress\" \"account\"\n"
            "\nSets the account associated with the given address.\n"

            "\nArguments:\n"
            "1. \"limitlessaddress\"  (string, required) The limitless address to be associated with an account.\n"
            "2. \"account\"         (string, required) The account to assign the address to.\n"

            "\nExamples:\n" +
            HelpExampleCli("setaccount", "\"TPZDAaACPtKkBAEf2EsKJLMPiDML2APWoM\" \"tabby\"") + HelpExampleRpc("setaccount", "\"TPZDAaACPtKkBAEf2EsKJLMPiDML2APWoM\", \"tabby\""));
...
UniValue getaccount(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 1)
        throw std::runtime_error(
            "getaccount \"limitlessaddress\"\n"
            "\nReturns the account associated with the given address.\n"

            "\nArguments:\n"
            "1. \"limitlessaddress\"  (string, required) The limitless address for account lookup.\n"

            "\nResult:\n"
            "\"accountname\"        (string) the account address\n"

            "\nExamples:\n" +
            HelpExampleCli("getaccount", "\"TPZDAaACPtKkBAEf2EsKJLMPiDML2APWoM\"") + HelpExampleRpc("getaccount", "\"TPZDAaACPtKkBAEf2EsKJLMPiDML2APWoM\""));
...
UniValue getaddressesbyaccount(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 1)
        throw std::runtime_error(
            ...
            "  \"limitlessaddress\"  (string) a limitless address associated with the given account\n"
            "  ,...\n"
            "]\n"
...
UniValue sendtoaddress(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() < 2 || params.size() > 4)
        throw std::runtime_error(
            "sendtoaddress \"limitlessaddress\" amount ( \"comment\" \"comment-to\" )\n"
            "\nSend an amount to a given address. The amount is a real and is rounded to the nearest 0.00000001\n" +
            HelpRequiringPassphrase() + "\n"

            "\nArguments:\n"
            "1. \"limitlessaddress\"  (string, required) The limitless address to send to.\n"
            ...
            "\nExamples:\n" +
            HelpExampleCli("sendtoaddress", "\"TPZDAaACPtKkBAEf2EsKJLMPiDML2APWoM\" 0.1") +
            HelpExampleCli("sendtoaddress", "\"TPZDAaACPtKkBAEf2EsKJLMPiDML2APWoM\" 0.1 \"donation\" \"seans outpost\"") +
            HelpExampleRpc("sendtoaddress", "\"TPZDAaACPtKkBAEf2EsKJLMPiDML2APWoM\", 0.1, \"donation\", \"seans outpost\""));
...
UniValue sendtoaddressix(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() < 2 || params.size() > 4)
        throw std::runtime_error(
            "sendtoaddressix \"limitlessaddress\" amount ( \"comment\" \"comment-to\" )\n"
            "\nSend an amount to a given address. The amount is a real and is rounded to the nearest 0.00000001\n" +
            HelpRequiringPassphrase() + "\n"
            ...
            "\nExamples:\n" +
            HelpExampleCli("sendtoaddressix", "\"TPZDAaACPtKkBAEf2EsKJLMPiDML2APWoM\" 0.1") +
            HelpExampleCli("sendtoaddressix", "\"TPZDAaACPtKkBAEf2EsKJLMPiDML2APWoM\" 0.1 \"donation\" \"seans outpost\"") +
            HelpExampleRpc("sendtoaddressix", "\"TPZDAaACPtKkBAEf2EsKJLMPiDML2APWoM\", 0.1, \"donation\", \"seans outpost\""));
...
UniValue listaddressgroupings(const UniValue& params, bool fHelp)
{
    if (fHelp)
        throw std::runtime_error(
            ...
            "  [\n"
            "    [\n"
            "      \"limitlessaddress\",     (string) The limitless address\n"
...
UniValue signmessage(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 2)
        throw std::runtime_error(
            "signmessage \"limitlessaddress\" \"message\"\n"
            "\nSign a message with the private key of an address" +
            HelpRequiringPassphrase() + "\n"

            "\nArguments:\n"
            "1. \"limitlessaddress\"  (string, required) The limitless address to use for the private key.\n"
            ...
            HelpExampleCli("signmessage", "\"TPZDAaACPtKkBAEf2EsKJLMPiDML2APWoM\" \"my message\"") +
            "\nVerify the signature\n" +
            HelpExampleCli("verifymessage", "\"TPZDAaACPtKkBAEf2EsKJLMPiDML2APWoM\" \"signature\" \"my message\"") +
            "\nAs json rpc\n" +
            HelpExampleRpc("signmessage", "\"TPZDAaACPtKkBAEf2EsKJLMPiDML2APWoM\", \"my message\""));
...
UniValue getreceivedbyaddress(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() < 1 || params.size() > 2)
        throw std::runtime_error(
            "getreceivedbyaddress \"limitlessaddress\" ( minconf )\n"
            "\nReturns the total amount received by the given limitlessaddress in transactions with at least minconf confirmations.\n"

            "\nArguments:\n"
            "1. \"limitlessaddress\"  (string, required) The limitless address for transactions.\n"
            ...
            HelpExampleCli("getreceivedbyaddress", "\"TPZDAaACPtKkBAEf2EsKJLMPiDML2APWoM\"") +
            "\nThe amount including unconfirmed transactions, zero confirmations\n" +
            HelpExampleCli("getreceivedbyaddress", "\"TPZDAaACPtKkBAEf2EsKJLMPiDML2APWoM\" 0") +
            "\nThe amount with at least 6 confirmation, very safe\n" +
            HelpExampleCli("getreceivedbyaddress", "\"TPZDAaACPtKkBAEf2EsKJLMPiDML2APWoM\" 6") +
            "\nAs a json rpc call\n" +
            HelpExampleRpc("getreceivedbyaddress", "\"TPZDAaACPtKkBAEf2EsKJLMPiDML2APWoM\", 6"));
...
UniValue sendfrom(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() < 3 || params.size() > 6)
        throw std::runtime_error(
            "sendfrom \"fromaccount\" \"tolimitlessaddress\" amount ( minconf \"comment\" \"comment-to\" )\n"
            "\nSent an amount from an account to a limitless address.\n"
            "The amount is a real and is rounded to the nearest 0.00000001." +
            HelpRequiringPassphrase() + "\n"

            "\nArguments:\n"
            "1. \"fromaccount\"       (string, required) The name of the account to send funds from. May be the default account using \"\".\n"
            "2. \"tolimitlessaddress\"  (string, required) The limitless address to send funds to.\n"
            ...
            HelpExampleCli("sendfrom", "\"\" \"TPZDAaACPtKkBAEf2EsKJLMPiDML2APWoM\" 0.01") +
            "\nSend 0.01 from the tabby account to the given address, funds must have at least 6 confirmations\n" +
            HelpExampleCli("sendfrom", "\"tabby\" \"TPZDAaACPtKkBAEf2EsKJLMPiDML2APWoM\" 0.01 6 \"donation\" \"seans outpost\"") +
            "\nAs a json rpc call\n" +
            HelpExampleRpc("sendfrom", "\"tabby\", \"TPZDAaACPtKkBAEf2EsKJLMPiDML2APWoM\", 0.01, 6, \"donation\", \"seans outpost\""));
...
UniValue sendmany(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() < 2 || params.size() > 4)
        throw std::runtime_error(
            ...
            "    {\n"
            "      \"address\":amount   (numeric) The limitless address is the key, the numeric amount in VIP is the value\n"
            "      ,...\n"
            "    }\n"
            ...
            HelpExampleCli("sendmany", "\"tabby\" \"{\\\"TPZDAaACPtKkBAEf2EsKJLMPiDML2APWoM\\\":0.01,\\\"TM993FEHjreKmfmeVfrU7XNP8gJqRX5uhb\\\":0.02}\"") +
            "\nSend two amounts to two different addresses setting the confirmation and comment:\n" +
            HelpExampleCli("sendmany", "\"tabby\" \"{\\\"TPZDAaACPtKkBAEf2EsKJLMPiDML2APWoM\\\":0.01,\\\"TM993FEHjreKmfmeVfrU7XNP8gJqRX5uhb\\\":0.02}\" 6 \"testing\"") +
            "\nAs a json rpc call\n" +
            HelpExampleRpc("sendmany", "\"tabby\", \"{\\\"TPZDAaACPtKkBAEf2EsKJLMPiDML2APWoM\\\":0.01,\\\"TM993FEHjreKmfmeVfrU7XNP8gJqRX5uhb\\\":0.02}\", 6, \"testing\""));
    ...
    for (const std::string& name_ : keys) {
        ...
        if (!address.IsValid())
            throw JSONRPCError(RPC_INVALID_ADDRESS_OR_KEY, std::string("Invalid VIP address: ")+name_);
...
UniValue addmultisigaddress(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() < 2 || params.size() > 3)
        throw std::runtime_error(
            ...
            "2. \"keysobject\"   (string, required) A json array of limitless addresses or hex-encoded public keys\n"
            "     [\n"
            "       \"address\"  (string) limitless address or hex-encoded public key\n"
            "       ...,\n"
            "     ]\n"
            "3. \"account\"      (string, optional) An account to assign the addresses to.\n"

            "\nResult:\n"
            "\"limitlessaddress\"  (string) A limitless address associated with the keys.\n"

            "\nExamples:\n"
            "\nAdd a multisig address from 2 addresses\n" +
            HelpExampleCli("addmultisigaddress", "2 \"[\\\"TPZDAaACPtKkBAEf2EsKJLMPiDML2APWoM\\\",\\\"TM993FEHjreKmfmeVfrU7XNP8gJqRX5uhb\\\"]\"") +
            "\nAs json rpc call\n" +
            HelpExampleRpc("addmultisigaddress", "2, \"[\\\"TPZDAaACPtKkBAEf2EsKJLMPiDML2APWoM\\\",\\\"TM993FEHjreKmfmeVfrU7XNP8gJqRX5uhb\\\"]\""));
...
UniValue listtransactions(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() > 4)
        throw std::runtime_error(
            ...
            "    \"address\":\"limitlessaddress\",    (string) The limitless address of the transaction. Not present for \n"
...
UniValue listsinceblock(const UniValue& params, bool fHelp)
{
    if (fHelp)
        throw std::runtime_error(
            ...
            "    \"address\":\"limitlessaddress\",    (string) The limitless address of the transaction. Not present for move transactions (category = move).\n"
...
UniValue gettransaction(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() < 1 || params.size() > 2)
        throw std::runtime_error(
            ...
            "      \"address\" : \"limitlessaddress\",   (string) The limitless address involved in the transaction\n"
...
UniValue walletlock(const UniValue& params, bool fHelp)
{
    if (pwalletMain->IsCrypted() && (fHelp || params.size() != 0))
        throw std::runtime_error(
            ...
            HelpExampleCli("sendtoaddress", "\"TPZDAaACPtKkBAEf2EsKJLMPiDML2APWoM\" 1.0") +
...
UniValue encryptwallet(const UniValue& params, bool fHelp)
{
    if (!pwalletMain->IsCrypted() && (fHelp || params.size() != 1))
        throw std::runtime_error(
            ...
            HelpExampleCli("signmessage", "\"limitlessaddress\" \"test message\"") +
    ...
    StartShutdown();
    return "wallet encrypted; limitless server stopping, restart to run with encrypted wallet. The keypool has been flushed, you need to make a new backup.";
}
...
UniValue listmintedzerocoins(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 2)
        throw std::runtime_error(
            ...
            "    \"zVIP ID\": \"xxx\",   (string) Pubcoin in hex format.\n"
    ...
    CWalletDB walletdb(pwalletMain->strWalletFile);
    std::set<CMintMeta> setMints = pwalletMain->zvipTracker->ListMints(true, fMatureOnly, true);
    ...
    if (fVerbose) {
        for (auto m : setMints) {
            ...
            objMint.push_back(Pair("zVIP ID", m.hashPubcoin.GetHex()));     // PubCoin
            ...
            if (m.hashStake == 0) {
                ...
                if (pwalletMain->GetMint(m.hashSerial, mint)) {
                    ...
                    pwalletMain->zvipTracker->UpdateState(m);
                }
            }
...
UniValue listzerocoinamounts(const UniValue& params, bool fHelp)
{
    ...
    CWalletDB walletdb(pwalletMain->strWalletFile);
    std::set<CMintMeta> setMints = pwalletMain->zvipTracker->ListMints(true, true, true);
...
UniValue mintzerocoin(const UniValue& params, bool fHelp)
{
    ...
    if (Params().NetworkID() != CBaseChainParams::REGTEST)
        throw JSONRPCError(RPC_WALLET_ERROR, "zVIP minting is DISABLED");
...
UniValue spendzerocoin(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() > 4 || params.size() < 3)
        throw std::runtime_error(
            ...
            "\nExamples\n" +
            HelpExampleCli("spendzerocoin", "5000 false true \"TPZDAaACPtKkBAEf2EsKJLMPiDML2APWoM\"") +
            HelpExampleRpc("spendzerocoin", "5000 false true \"TPZDAaACPtKkBAEf2EsKJLMPiDML2APWoM\""));
    ...
    if (fMintChange && Params().NetworkID() != CBaseChainParams::REGTEST)
        throw JSONRPCError(RPC_WALLET_ERROR, "zVIP minting is DISABLED, cannot mint change");
    ...
    if (!ispublicspend && Params().NetworkID() != CBaseChainParams::REGTEST) {
        throw JSONRPCError(RPC_WALLET_ERROR, "zVIP old spend only available in regtest for tests purposes");
    }

    return DoZvipSpend(nAmount, fMintChange, fMinimizeChange, vMintsSelected, address_str, ispublicspend);
}
...
UniValue spendzerocoinmints(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() < 1 || params.size() > 2)
        throw std::runtime_error(
            ...
            "\nSpend zVIP mints to a VIP address.\n" +
            HelpRequiringPassphrase() + "\n"
            ...
            "\nExamples\n" +
            HelpExampleCli("spendzerocoinmints", "'[\"0d8c16eee7737e3cc1e4e70dc006634182b175e039700931283b202715a0818f\", \"dfe585659e265e6a509d93effb906d3d2a0ac2fe3464b2c3b6d71a3ef34c8ad7\"]' \"TPZDAaACPtKkBAEf2EsKJLMPiDML2APWoM\"") +
            HelpExampleRpc("spendzerocoinmints", "[\"0d8c16eee7737e3cc1e4e70dc006634182b175e039700931283b202715a0818f\", \"dfe585659e265e6a509d93effb906d3d2a0ac2fe3464b2c3b6d71a3ef34c8ad7\"], \"TPZDAaACPtKkBAEf2EsKJLMPiDML2APWoM\""));
    ...
    return DoZvipSpend(nAmount, false, true, vMintsSelected, address_str);
}


extern UniValue DoZvipSpend(const CAmount nAmount, bool fMintChange, bool fMinimizeChange, std::vector<CZerocoinMint>& vMintsSelected, std::string address_str, bool ispublicspend)
{
...
UniValue resetmintzerocoin(const UniValue& params, bool fHelp)
{
    ...
    CWalletDB walletdb(pwalletMain->strWalletFile);
    CzcTracker* zvipTracker = pwalletMain->zvipTracker.get();
    std::set<CMintMeta> setMints = zvipTracker->ListMints(false, false, true);
...
UniValue resetspentzerocoin(const UniValue& params, bool fHelp)
{
    ...
    CWalletDB walletdb(pwalletMain->strWalletFile);
    CzcTracker* zvipTracker = pwalletMain->zvipTracker.get();
    std::set<CMintMeta> setMints = zvipTracker->ListMints(false, false, false);
...
UniValue exportzerocoins(const UniValue& params, bool fHelp)
{
    if(fHelp || params.empty() || params.size() > 2)
        throw std::runtime_error(
            ...
            "  {\n"
            "    \"id\": \"serial hash\",  (string) the mint's zVIP serial hash \n"
    ...
    CzcTracker* zvipTracker = pwalletMain->zvipTracker.get();
    std::set<CMintMeta> setMints = zvipTracker->ListMints(!fIncludeSpent, false, false);
...
UniValue setzvipseed(const UniValue& params, bool fHelp)
{
    ...
    CzcWallet* zwallet = pwalletMain->getZWallet();
...
UniValue generatemintlist(const UniValue& params, bool fHelp)
{
    ...
    CzcWallet* zwallet = pwalletMain->zwalletMain;
...
void static SearchThread(CzcWallet* zwallet, int nCountStart, int nCountEnd)
{
    ...
    try {
        ...
        for(int i = nCountStart; i < nCountEnd; i++) {
            ...
            CKey key;
            zwallet->SeedToZC(zerocoinSeed, bnValue, bnSerial, bnRandomness, key);
...
UniValue createautomintaddress(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 0)
        throw std::runtime_error(
                ...
                "\nResult\n"
                "\"address\"     (string) VIP address for auto minting\n" +
...
UniValue spendrawzerocoin(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() < 4 || params.size() > 5)
        throw std::runtime_error(
            ...
            "5. \"address\"          (string, optional) VIP address to spend to. If not specified, spend to change add.\n"
...
UniValue clearspendcache(const UniValue& params, bool fHelp)
{
    if(fHelp || params.size() != 0)
        throw std::runtime_error(
            "clearspendcache\n"
            "\nClear the pre-computed zVIP spend cache, and database.\n" +
            HelpRequiringPassphrase() + "\n"
...

    {
        int nTries = 0;
        while (nTries < 100) {
            TRY_LOCK(zvipTracker->cs_spendcache, fLocked);
            if (fLocked) {
                if (zvipTracker->ClearSpendCache()) {
