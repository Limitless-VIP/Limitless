...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Limitless Core limitless-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  limitless-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded limitless transaction") + "\n" +
                               "  limitless-tx [options] -create [commands]   " + _("Create hex-encoded limitless transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded limitless transaction
