...
/** Utility functions used by the Limitless Qt UI.
 */
namespace GUIUtil
{
...
// Render Limitless addresses in monospace font
...
// Parse "limitless:" URI into recipient object, return true on successful parsing
