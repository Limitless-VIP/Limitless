...
/** Utility functions used by the TittieCoin Qt UI.
 */
namespace GUIUtil
{
...
// Render TittieCoin addresses in monospace font
...
// Parse "tittiecoin:" URI into recipient object, return true on successful parsing
