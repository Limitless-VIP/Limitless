...
<context>
    ...
    <message>
        ...
        <translation>Limitless сейчас закроется, чтобы завершить процесс шифрования. Помните, что шифрование вашего кошелька не может полностью защитить ваши VIP от кражи с использованием вредоносного ПО.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>&amp;О Limitless Core</translation>
    </message>
    <message>
        <source>Show information about Limitless Core</source>
        <translation>Показать информацию о Limitless Core</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Смотрите помощь к программе, чтобы получить документацию ко всем возможным опциям комманды Limitless</translation>
    </message>
    <message>
        <source>Limitless Core client</source>
        <translation>Клиент Limitless Core</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Будут показаны не все транзакции. Для отображения всех транзакций необходимо выставить txindex=1 в конфигурационном файле (limitless.conf).</translation>
    </message>
</context>
<context>
...
<context>
    ...
    <message>
        ...
        <translation>Добро пожаловать в Limitless Core.</translation>
    </message>
    <message>
        <source>As this is the first time the program is launched, you can choose where Limitless Core will store its data.</source>
        <translation>Поскольку это первый запуск программы, вы можете выбрать, где будут храниться данные Limitless Core.</translation>
    </message>
    <message>
        ...
        <translation>Limitless Core загрузит и сохранит копию цепочки блоков VIP. Каталог будет занимать около %1GB и со временем размер будет увеличиваться. Кроме того, в этом каталоге будет храниться кошелек.</translation>
    </message>
    <message>
...
https://www.transifex.com/limitless-project/limitless-project-translations</translation>
    ...
    <message>
        ...
        <translation>Подключиться к сети Limitless через SOCKS5 прокси.</translation>
    </message>
    <message>
...
Незрелый: подтвержден, но менее 1 чеканок того же наименования после того, как он был отчеканен</translation>
    ...
    <message>
        ...
        <translation>Возможно отображаемая информация устарела. Ваш кошелек автоматически синхронизируется с сетью Limitless после установки соединения, но этот процесс еще не завершен. </translation>
    </message>
    <message>
        <source>OVERVIEW</source>
        <translation>ОБЗОР</translation>
...
Чтобы включить Авточеканку, измените 'enablezeromint = 0' на 'enablezeromint = 1' в файле limitless.conf</translation>
    </message>
</context>
<context>
    ...
    <message>
        ...
        <translation>Не удалось запустить limitless: обработчик click-to-pay </translation>
    </message>
    <message>
...
- включить: добавить 'enablezeromint = 1' в limitless.conf
- отключить: добавить 'enablezeromint = 0' в limitless.conf
...
<context>
    ...
    <message>
        ...
        <translation>Необязательное сообщение для присоединения к платежному запросу, которое будет отображаться при открытии запроса. Примечание. Сообщение не будет отправлено с оплатой через сеть Limitless.</translation>
    </message>
    <message>
        <source>RECEIVE</source>
    ...
    <message>
        ...
        <translation>Необязательное сообщение для присоединения к платежному запросу, которое будет отображаться при открытии запроса. &lt;br&gt;Примечание. Сообщение не будет отправлено с оплатой через сеть Limitless.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Сообщение, которое было прикреплено к URI VIP: URI, который будет сохранен с транзакцией для вашей справки. Примечание. Это сообщение не будет отправлено через сеть Limitless.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Limitless Core выключается...</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Разработчики Limitless Core</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Не удается получить блокировку в каталоге данных %s. Limitless Core, вероятно, уже запущен.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Не удалось привязать к %s на этом компьютере. Limitless Core, вероятно, уже запущен.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Невозможно найти достаточное количество средств, не предназначенных для обфускации, для этой транзакции, которые не равны 15000 VIP.</translation>
    </message>
    <message>
        <source>Unable to locate enough funds for this transaction that are not equal 15000 VIP.</source>
        <translation>Не удалось найти достаточное количество средств для этой транзакции, которые не равны 15000 VIP.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Внимание: проверьте правильность даты и времени вашего компьютера! Если ваши часы ошибочны, Limitless Core не будет работать должным образом.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>(8007 можно использовать только в сети)</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>(должен быть 8007 для mainet)</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Copyright (C) 2019-%i Разработчики Limitless Core</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Ошибка загрузки wallet.dat: Кошелек требует более новой версии Limitless Core</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Инициализация проверки работоспособности не удалась. Limitless Core отключается.</translation>
    </message>
    <message>
        <source>Insufficient funds</source>
        <translation>Недостаточно средств.</translation>
    ...
    <message>
        ...
        <translation>Кошелек необходимо переписать: перезапустите Limitless Core, чтобы завершить</translation>
    </message>
    <message>
