...
bool Intro::pickDataDirectory(bool& bootstrap)
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("Limitless Core"),
     ...
     * override -datadir in the limitless.conf file in the default data directory
     * (to be consistent with limitlessd behavior)
     */
    if (dataDir != getDefaultDataDirectory())
