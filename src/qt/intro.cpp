...
void Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("TittieCoin Core"),
     ...
     * override -datadir in the tittiecoin.conf file in the default data directory
     * (to be consistent with tittiecoind behavior)
     */
    if (dataDir != getDefaultDataDirectory())
