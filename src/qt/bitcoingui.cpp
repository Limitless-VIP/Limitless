                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Limitless Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Limitless address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and limitless: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Limitless Core"), this);
    aboutAction->setStatusTip(tr("Show information about Limitless Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Limitless"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Limitless addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Limitless addresses"));
    ...
    openAction->setStatusTip(tr("Open a Limitless: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Limitless Core help message to get a list with possible Limitless command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Limitless Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Limitless network", "", count));
}
...
{
    QString strTitle = tr("Limitless Core"); // default title
