...
/* Limitless GUI -- Size of icons in status bar */
...
#define COLOR_UNCONFIRMED QColor(166, 168, 167)
...
#define COLOR_CONFLICTED QColor(231, 76, 60)
/* Transaction list -- TX status decoration - orphan (Light Gray #D3D3D3) */
#define COLOR_ORPHAN QColor(166, 168, 167)
...
#define QAPP_ORG_NAME "Limitless"
#define QAPP_ORG_DOMAIN "limitlessvip.co.za"
#define QAPP_APP_NAME_DEFAULT "Limitless-Vip-Qt"
#define QAPP_APP_NAME_TESTNET "Limitless-Vip-Qt-testnet"
